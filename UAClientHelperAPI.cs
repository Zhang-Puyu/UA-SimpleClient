...
namespace Siemens.UAClientHelper
{
    public class UAClientHelperAPI
    {
        ...
        /// <summary> 
        /// Provides a reconnect handler.
        /// </summary>
        private SessionReconnectHandler mReconnectHandler;
        ...
        public async Task Connect(EndpointDescription endpointDescription, bool userAuth, string userName, string password)
        {
            ...
            mSession.KeepAlive += new KeepAliveEventHandler(Session_KeepAlive);
        }
        ...
        public void WriteValues(Dictionary<NodeId, IEnumerable<string>> valuesByNodeId)
        {
            ...
            //MessageBox.Show("The value was written successfully.", "Success");
        }
        #endregion
        ...
        private void Session_KeepAlive(ISession session, KeepAliveEventArgs e)
        {
            try
            {
                ...
                if (ServiceResult.IsBad(e.Status))
                {
                    ...
                    {
                        mReconnectHandler = new SessionReconnectHandler();
                        mReconnectHandler.BeginReconnect(mSession, ReconnectPeriod * 1000, Server_ReconnectComplete);
                    }
                }
            }
            catch (Exception ex)
        ...
        private void Server_ReconnectComplete(object sender, EventArgs e)
        {
            try
            {
                ...
                if (!Object.ReferenceEquals(sender, mReconnectHandler))
                {
                    return;
                }
                mSession = (Session)mReconnectHandler.Session;
                mReconnectHandler.Dispose();
